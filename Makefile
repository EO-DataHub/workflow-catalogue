...
IMAGE_NAME=workflow-catalogue
CONTAINER_NAME=workflow-catalogue
DOCKERFILE_PATH=.
...
testcov:
	@rm -rf htmlcov
	uv run pytest -v --cov-report html --cov-report xml --cov=src/workflow_catalogue tests/
