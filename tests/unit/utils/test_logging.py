...
from workflow_catalogue.utils.logging import get_logger, timing_context
...
@patch("workflow_catalogue.utils.logging.time.time", MagicMock(side_effect=[100.0, 101.0]))
